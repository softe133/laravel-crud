					...
					<div class="card">
						...
						<div class="card-body">
							...
							<form id="userUpdateForm">
                                ...
                                <label><input type="checkbox" name="roles" value="Administrator" class="get_value" checked="true"> Administrator</label>
                                @endif<br>
                                @if (strpos($user->roles, 'Editor') !== false)
                                <label><input type="checkbox" name="roles" value="Editor" class="get_value" checked="true"> Editor</label>
                                @endif<br>
                                @if (strpos($user->roles, 'Subscriber') !== false)
                                <label><input type="checkbox" name="roles" value="Subscriber" class="get_value" checked="true"> Subscriber </label>
                                @endif
                                </div>  
